...
const AboutUs = () => {
  useSEO({
    title:
      "About Us - Brander Store | Premium Hair Accessories & Kitchen Appliances",
    description:
      "Learn about Brander Store, your trusted source for premium hair accessories and innovative kitchen appliances. Discover our commitment to quality and customer satisfaction.",
    keywords: [
      "about us",
      "brander store",
      "company",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
              ...
              innovative design. We believe in quality, sustainability, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-4 sm:space-y-6 text-gray-600 text-sm sm:text-base">
                <p>
                  Founded in 2020, Brandter began as a vision to create a
                  marketplace where quality meets affordability. We started with
                  a simple belief that everyone deserves access to premium
                  products that enhance their lifestyle.
                </p>
                <p>
                  What started as a small team of passionate individuals has
                  grown into a trusted brand serving thousands of customers
                  worldwide. Our commitment to excellence drives everything we
                  do.
                </p>
                <p>
                  Today, we continue to innovate and expand our product range
                  while maintaining our core values of quality, sustainability,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                We're committed to protecting our planet through sustainable
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                ...
                artisans and businesses worldwide.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-purple-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
            Join thousands of satisfied customers who have made Brandter their
            preferred choice for premium products and exceptional service.
          </p>
          <Link
            to="/shop"
            className="bg-white text-purple-600 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 text-sm sm:text-base"
          >
            Start Shopping
          </Link>
        </div>
